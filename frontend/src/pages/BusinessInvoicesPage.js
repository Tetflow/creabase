      ...
      <nav className="sticky top-0 z-50 bg-[#FAFAFA] border-b-2 border-[#0A0A0A] px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-black tracking-tight">Business Invoices</h1>
          </div>
        </div>
      </nav>
                ...
                <div className="flex flex-col md:flex-row justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div>
                        <p className="text-xs font-bold uppercase text-[#4A4A4A] mb-1">Total Paid</p>
